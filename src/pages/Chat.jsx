  ...
  const conversations = [
    {
      ...
      lastMessage: { text: 'Hello there!', timestamp: new Date().getTime() - 3600000 }
    },
    {
      id: 'conv2',
      user: { id: 'user789', name: 'John Smith', email: 'john@example.com' },
      lastMessage: { text: 'Good to see you', timestamp: new Date().getTime() - 7200000 }
    },
    {
      id: 'conv3',
      user: { id: 'user101', name: 'Sarah Wilson', email: 'sarah@example.com' },
      lastMessage: { text: 'Thanks for your help!', timestamp: new Date().getTime() - 86400000 }
    }
  ]
